        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ul class="nav nav-tabs" role="tablist" id="myTabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#business" role="tab" data-toggle="tab" aria-expanded="true">Offres d'achat</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#events" role="tab" data-toggle="tab" aria-expanded="false">Evenements</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#posts" role="tab" data-toggle="tab" aria-expanded="false">Articles</a>
                    </li>
                </ul>
                <br><br>
