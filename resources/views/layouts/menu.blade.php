        ...
        <div class="navbar-collapse collapse dual-nav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    @else
                    <a class="nav-link" data-toggle="modal" data-target="#countryModal">Pays <span class="sr-only">(cette page)</span></a>
                    @endif
                </li>
                @endauth
                @auth
                ...
                @auth
                <li class="nav-item">
                    <a class="nav-link" href="/messages">Chat <span class="sr-only">(cette page)</span></a>
                </li>
                @endauth
                <!-- /nav-item -->
                {{--
